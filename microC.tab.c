...
/* Line 1455 of yacc.c  */
#line 82 "microC.y"
    { (yyval.u)=GenUzel(INKREM,NULL,(yyvsp[(1) - (2)].u)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 84 "microC.y"
    { (yyval.u)=GenUzel(DEKREM,NULL,(yyvsp[(1) - (2)].u)); ;}
    break;
